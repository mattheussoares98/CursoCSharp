...
namespace CursoCSharp.Colecoes {
    internal class Igualdade {
        public static void Executar() {
            ...
            Produto produto2 = new Produto(nome: "Mattheus", preco: 10);

            Console.WriteLine(produto1 == produto2); //como ocupam locais diferentes da memória, retorna false
            ...
            Console.WriteLine(produto3 == produto2); //como ocupam o mesmo local da memória, retorna true
        }
    }
}
