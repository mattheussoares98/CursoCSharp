...
namespace CursoCSharp.Fundamentos {
    internal class Conversoes {
        public static void Executar() {
            ...
            string primeiraPalavra = Console.ReadLine() ?? "0";
            int.TryParse(primeiraPalavra, out int primeiroNumeroConvertido);
            ...
            bool converteu = int.TryParse(Console.ReadLine(), out int numeroConvertido );
